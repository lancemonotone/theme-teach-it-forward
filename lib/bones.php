...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		wp_register_style( 'bones-stylesheet', get_stylesheet_directory_uri() . '/assets/build/css/style.css', array(), '1.6', 'all' );

		// ie-only style sheet
		wp_register_style( 'bones-ie-only', get_stylesheet_directory_uri() . '/assets/build/css/ie.css', array(), '' );
