...
define('CPTPATH',    get_template_directory() . '/plugins/custom-post-type-ui/');
define('CPTURL',     get_template_directory_uri() . '/plugins/custom-post-type-ui/');
...
function cptui_load_ui_class() {
	require_once( CPTPATH . 'classes/class.cptui_admin_ui.php' );
}
...
function cptui_create_submenus() {
	require_once( CPTPATH . 'inc/post-types.php' );
	require_once( CPTPATH . 'inc/taxonomies.php' );
	require_once( CPTPATH . 'inc/listings.php' );
	require_once( CPTPATH . 'inc/import_export.php' );
	require_once( CPTPATH . 'inc/support.php' );
}
add_action( 'init', 'cptui_create_submenus' );

function cptui_add_styles() {
	wp_enqueue_style( 'cptui-css', CPTURL . 'css/cptui.css' );
}
			...
			<tr>
				<td class="one-third valign">
					...
					<a href="http://bit.ly/prowp3" target="_blank">
						<img src="<?php echo CPTURL . '/images/professional-wordpress-thirdedition.jpg'; ?>" width="200">
					</a>
					<br />
				...
				<td class="one-third valign">
					...
					<a href="http://amzn.to/plugindevbook" target="_blank">
						<img src="<?php echo CPTURL . '/images/professional-wordpress-plugin-development.png'; ?>" width="200">
					</a>
					<br />
